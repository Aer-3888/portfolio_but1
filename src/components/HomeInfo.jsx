    ...
    const renderContent = {
        1: (
            <div className='info-box'>
                ...
                <a href={getPDFUrl("documents/CV_PHAN_Theo.pdf")}  className='neo-brutalism-white neo-btn'>
                    Mon CV
        ...
        2: <div className='info-box'>
                ...
                <a href={getPDFUrl("documents/Lettre_de_motivation_PHAN_Theo.pdf")} className='neo-brutalism-white neo-btn'>
